...
GSK cloud-edge: the Traefik-backed `clubhouse` Gateway with five HTTPS listeners,
...
| Hostnames | `clubhouse.kaddy.local` | `{argocd,grafana,demo,caddy,portal}.lab.platformrelay.dev` |
...
in each app's namespace (argocd / monitoring / caddy-demo / caddy-mvp / portal) and attach
