...
appx_has 'NixOS|Nix'                              "NixOS path (appendix)"
appx_has '[Dd]esigned'                            "NixOS tagged designed"
appx_has 'ADR-0303|E14'                           "NixOS refs E14/ADR-0303"
appx_has 'flake\.nix'                             "no-flake.nix honesty caveat"
